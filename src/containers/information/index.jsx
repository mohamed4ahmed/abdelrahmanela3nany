            ...
            <div className="information">
              ...
              <div className="social">
                <a
                  rel="noopener noreferrer"
                  target="__blank"
                  href="https://www.facebook.com/abdelrahman.elanany.5"
                  aria-label="Facebook"
                >
                  <div className="icon">
                    <img
              ...
              <div className="social">
                <a
                  rel="noopener noreferrer"
                  target="__blank"
                  href="https://www.messenger.com/t/abdelrahman.elanany.5/?messaging_source%3Apages%message_shortlink"
              ...
              <div className="social">
                <a
                  rel="noopener noreferrer"
                  target="__blank"
                  href="https://instagram.com/abdelrahman.el3nany?igshid=YmMyMTA2M2Y="
              ...
              <div className="social">
                <a
                  rel="noopener noreferrer"
                  target="__blank"
                  href="https://twitter.com/ael3nany28?t=kCNSzNam_gwaNG-iJKrZEQ&s=09"
                >
                  <div className="icon">
                    <img
              ...
              <div className="social">
                <a
                  rel="noopener noreferrer"
                  target="__blank"
                  href="https://www.snapchat.com/add/ael3nany28?share_id=h8hSKkQS5bU&locale=ar-EG"
                >
                  <div className="icon">
                    <img
              ...
              <div className="social">
                <a href="whatsapp://send?text=welcome&phone=+201009282162">
                  <div className="icon">
                    <img
